...
* citation style: `csl`. You can search and download one(e.g., ACM or IEEE) from [here](https://www.zotero.org/styles?q=acm). Save it in the same directory with your article.
